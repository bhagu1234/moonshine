						...
						<div class="card">
							...
							<div class="card-body p-4">
								<form class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div id="advanceCustomer">
                                        <div class="col-md-12">
                                            <label class="form-label">Contact</label>
                                            <input type="text" class="form-control" id="customerContact" placeholder="Contact" >
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="customerCreditFacility" placeholder="Credit Facility" >
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Visite & Rating</label>
                                            <input type="text" class="form-control" id="customerVisiteRating" placeholder="Visite & Rating" >
                                        </div>
                                    </div>
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											<button type="submit" class="btn btn-primary px-4" id="storeCustomer">Submit</button>
                                            <button class="btn btn-light px-4" id="addAdvanceCustomer">Add Advance</button>
										</div>
									</div>
								</form>
							</div>
