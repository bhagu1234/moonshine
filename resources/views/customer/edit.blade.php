							...
							<div class="card-body p-4">
								<form class="row g-3 needs-validation" novalidate>
									...
									<div class="col-md-12">
										...
										<select id="update_customer_country" class="form-select"  data-placeholder="Choose one thing" onchange="getAddress(this.value,'country')" required>
										</select>
									</div>
                                    <div class="col-md-12">
										<label for="bsValidation9" class="form-label">State</label>
										<select id="update_CustomerState" class="form-select"  data-placeholder="Choose one thing" onchange="getAddress(this.value,'state')" required>
										</select>
									</div>
                                    <div class="col-md-12">
										<label for="bsValidation9" class="form-label">District</label>
										<select id="update_CustomerDistrict" class="form-select"  data-placeholder="Choose one thing" onchange="getAddress(this.value,'district')"   required>
										</select>
									</div>
                                    <div class="col-md-12">
										<label for="bsValidation9" class="form-label">City</label>
										<select id="update_CustomerCity" class="form-select"  data-placeholder="Choose one thing" required>
										</select>
									</div>
                                    <div class="col-md-12">
										<label for="bsValidation9" class="form-label">Region</label>
										<select id="update_CustomerRegion" class="form-select"  data-placeholder="Choose one thing" required>
										</select>
									</div>
                                    <div class="col-md-12">
										<label for="bsValidation9" class="form-label">Address Type</label>
										<select id="update_CustomerType" class="form-select"  data-placeholder="Choose one thing" required>
										</select>
									</div>
									<div class="col-md-6">
