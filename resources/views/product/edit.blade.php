<div class="container">
    <div class="modal fade bd-example-modal-xl" data-backdrop="static" id="updateProductModal" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content" style="height:fit-content;z-index':1039 !important ">
                <div class="modal-header">
                    ...
                    <button type="button" class="button-24 close_openupdateProductModal" data-dismiss="modal">×</button>
                </div>
							...
							<div class="card-body p-4">
								<form class="row g-3 needs-validation" novalidate>
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="update_product_specific_name" placeholder="Product Specific Name">
									</div>
									<div class="col-md-6">
										<label for="bsValidation2" class="form-label">Product Full Name</label>
										<input type="text" class="form-control" id="update_product_full_name" placeholder="Product Full Name" >
									</div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										...
										<textarea class="form-control" id="update_product_grades"  rows="3" ></textarea>
									</div>
                                    <h5>OTHER DETAILS :</h5>
                                    <div class="col-md-6">
										<label  class="form-label">Standards</label>
										<textarea class="form-control"   rows="3" id="update_product_standards" ></textarea>
									</div>
                                    <div class="col-md-6">
										<label  class="form-label">Dimensions & Properties</label>
										<textarea class="form-control"   rows="3" id="update_product_DimensionsProperties" ></textarea>
									</div>
									<div class="col-md-6">
										<label for="bsValidation3" class="form-label">Technical Specs</label>
										<textarea class="form-control"   rows="3"  id="update_product_TechnicalSpecs" placeholder="Technical Specs" ></textarea>
									</div>
									<div class="col-md-6">
										<label for="bsValidation3" class="form-label">Applications</label>
										<textarea class="form-control"   rows="3"  id="update_product_Applications" placeholder="Applications" ></textarea>
									</div>
									<div class="col-md-6">
										<label for="bsValidation3" class="form-label"> Price Structure</label>
										<textarea class="form-control"   rows="3"  id="update_product_PriceStructure" placeholder=" Price Structure" ></textarea>
									</div>
									<div class="col-md-6">
										<label for="bsValidation3" class="form-label"> Packing Method</label>
										<textarea class="form-control"   rows="3"  id="update_product_PackingMethod" placeholder=" Packing Method" ></textarea>
									</div>
									<div class="col-md-6">
										<label for="bsValidation3" class="form-label">Weight calculation</label>
										<textarea class="form-control"   rows="3"  id="update_product_Weightcalculation" placeholder="Weight calculation" ></textarea>
									</div>
									<div class="col-md-6">
										<label for="bsValidation3" class="form-label">Comments</label>
										<textarea class="form-control"   rows="3"  id="update_product_Comments" placeholder="Comments" ></textarea>
									</div>
                                    <div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="update_product_shipmentMode" placeholder="Shipment Mode" >
									</div>
                                    <div class="col-md-6">
										<label for="bsValidation4" class="form-label">HS Code</label>
										<input type="text" class="form-control" id="update_product_HSCode" placeholder="HS Code" >
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											<button type="button" class="btn btn-primary px-4" id="update_Product">Submit</button>
										</div>
									</div>
								</form>
							</div>
                ...
                <div class="modal-footer">
                    <button type="button" class="button-57_alt button-58_alt close_openupdateProductModal" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
